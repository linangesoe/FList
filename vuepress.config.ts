...
export default defineUserConfig({
  ...
  title: 'NanGeList',
  // 网站的简介，有助于搜索引擎收录
  description: 'NanGeList - 将 GitHub Releases 以类似网盘的形式展示在网页上，方便用户下载开源软件。 支持视频、音频、图片、PDF 等文件的在线预览。',
  ...
  theme: FileList([
    ...
    },*/
    {
      ...
      analysis: fileUrlTreeAnalysis({
        "/FList/WordPress丨7.3_子比主题": "https://www.123pan.com/s/T9VtVv-1MMr3.html",
        "/FList/WordPress丨7.3_子比主题": "https://www.123pan.com/s/T9VtVv-1MMr3.html"
